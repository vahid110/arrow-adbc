...
For Ubuntu 24.04 x86-64 evaluation, the
[development-package workflow](https://github.com/vahid110/arrow-adbc/actions/workflows/pgwire-package.yml)
publishes a seven-day archive and SHA-256 file. Its embedded `README.md`
explains extraction and runtime requirements. CI checks the extracted archive
with an independent client, but the artifact is not a production release and
its packaged binary has not yet passed a live Redshift connection test.
